...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0.29301455154679307; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.38585977835573304; // x position of the perpendicular encoder (in tick units)
    }
